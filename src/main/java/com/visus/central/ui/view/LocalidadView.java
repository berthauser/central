...
public class LocalidadView extends VerticalLayout {
    ...
    public LocalidadView(LocalidadUseCase localidadService, DepartamentoUseCase departamentoService) {
        this.localidadService = localidadService;
        this.departamentoService = departamentoService;

        form = new LocalidadForm(departamentoService.listar());
    ...
    private void iniciarAlta() {
        ...
        // Opcional: asignar un departamento por defecto
        if (!departamentoService.listar().isEmpty()) {
            nuevaLocalidad.setDepartamento(departamentoService.listar().get(0));
        }
        form.setEntity(nuevaLocalidad);
    ...
    private void configurarGrilla() {
        ...
        grid.addColumn(l -> l.getDepartamento() != null ? l.getDepartamento().getNombre() : "")
    ...
    private void actualizarLista() {
        ...
        List<Localidad> filtradas = todas.stream()
            .filter(l -> l.getNombre().toLowerCase().contains(texto))
            .toList();
